						...
						<div class="product-info">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<tr>
    									<th style="text-align : center ;">REVENDEURS</th>
    									<th style="text-align : center ;">PRIX TTC</th> 
    									
  									</tr>
										<c:forEach var="i" varStatus="c" items="${product.pricedetails }">
										<tr>
    										<td style="text-align : center ;">
    										
    										<a href="${i.link }" style="position:relative;" 
    										...
    										popups[${c.count}-1].style.display='block';">
    										<div class="popup" onmouseout="this.style.display='none';">
											<div>
												<img class ="smallimg" src="assets/images/blank.gif" data-echo=${i.imglink } alt="product pic">
											<div class ="smalldesc">
												${i.description }
											</div>
											</div>
											</div>
    										<img alt="" src="${i.vendorimglink }" heigth="130" width="180"></a>
    										</td>
    										<td style="text-align : center ;">
    										<div class="price-box">
											<span class="price" style="heigth:50%;width:50%;">${i.price } TND</span>
											</div>
											</td> 
  										</tr>
