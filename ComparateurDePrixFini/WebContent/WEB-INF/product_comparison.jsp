...
<body class="cnt-home">
	...
	<div class="body-content outer-top-xs">
		<div class='container'>
			<div class="row product-comparison inner-bottom-sm">
				<h1 class="page-title text-center">product comparison</h1>
				<div class="table-responsive">
					<table class="table table-bordered compare-table inner-top-vs">
						<tr>
							...
							<!-- testp -->
							<c:forEach items="${productstocompare}" var="produit">
								<td>
									<div class="product">
										<div class="product-image">
											<div class="image">
												<a href="detail.html"> <img alt="" style="width:12em ; height:12em;"
													src="<c:out value="${produit.imglink}" />">
												</a>
											</div>
											...
											<div class="product-info text-left"
												...
												<h3 class="name">
													<a href="detail.html"><c:out value="${produit.name}" /></a>
												</h3>
											</div>
										</div>
									</div>
								...
								<td>
									<div class="product-price" style="text-align: center;">
										<span class="price"> <c:out
												value="A partir de ${produit.bestprice}" />
										</span>
									</div>
								</td>
							</c:forEach>
						...
						<tr>
							<th>Remove</th>
							<c:forEach items="${productstocompare}" var="produit">
								<td class='text-center'><a href="#" class="remove-icon"><i
