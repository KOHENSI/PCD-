...
<!--n'est pas important couleur du page-->
<!--  <link rel="stylesheet" href="assets/css/green.css">-->
<link href="assets/css/blue.css" rel="stylesheet" title="Blue color">
				...
				<div class="header-top-inner">
					<div class="cnt-account">
						<ul class="list-unstyled">
							<li><a
								href="${!empty sessionScope.sessionMember ? 'url-Espace-Member' : '#connecter'}">
									<i class="icon fa fa-user"></i> ${!empty sessionScope.sessionMember ? sessionScope.sessionMember.pseudonym : 'Mon compte
'}
							</a></li>
			...
			<div class="sign-in-page inner-bottom-sm">
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 sign-in" style="height: 100%;">
						...
						<form class="register-form outer-top-xs" method="post"
							...
							<div class="form-group">
								<label class="info-title" for="exampleInputEmail1">Adresse
									email<span>*</span>
								</label> <input type="email"
									class="form-control unicase-form-control text-input"
									id="exampleInputEmail1" name="email" required><span
									class="erreur">${formConnect.erreurs['email']}</span>
							</div>
							<div class="form-group">
								<label class="info-title" for="exampleInputPassword1">Mot
									de passe <span>*</span>
								</label> <input type="password"
									class="form-control unicase-form-control text-input"
									id="exampleInputPassword1" name="motdepasse" required><span
									class="erreur">${formConnect.erreurs['motdepasse']}</span>
							</div>
							<div class="radio outer-xs">
								<label> <input type="radio" name="optionsRadios"
									id="optionsRadios2" value="option2">Se souvenir de moi !
								</label> <a href="#" class="forgot-password pull-right">Mot de passe
									oublié?</a>
							</div>
							<button type="submit" value="connexion" name="bouton_validation"
								class="btn-upper btn btn-primary checkout-page-button"
								style="width: 100%;">S'identifier</button>
							<br />
							<p
								class="${empty formConnect.erreurs ? formConnect.htmlClassSucess : formConnect.htmlClassFail}">${formConnect.resultat}</p>
							<!--  	${formConnect.erreurs['motdepasse']}
							<c:forEach items="${ formConnect.erreurs }" var="titre"
								varStatus="status">
								<p>
									N°
									<c:out value="${ status.count }" />
									:
									<c:out value="${ formConnect.erreurs }" />
									!
								</p>
							</c:forEach>
							${memberConncet.getPassword()}
					...
					<div class="col-md-6 col-sm-6 create-new-account"
						...
						<p class="text title-tag-line">Créez votre propre compte
							Unicase.</p>

						<form method="post" class="register-form outer-top-xs"
							action="connexion">
							<div class="form-group">
								<label class="info-title" for="exampleInputEmail2">Adresse
									email <span class="requis">*</span>
								</label> <input size="20" maxlength="60" type="email"
									class="form-control unicase-form-control text-input"
									id="exampleInputEmail2" name="email" required> <span
									class="erreur">${formInscri.erreurs['email']}</span>
							</div>
							<div class="form-group">
								<label class="info-title" for="exampleInputEmail2">Pseudonyme
									<span class="requis">*</span>
								</label> <input type="text" name="nom"
									class="form-control unicase-form-control text-input"
									id="exampleInputEmail2" size="20" maxlength="20" required> <span
									class="erreur">${formInscri.erreurs['nom']}</span>
							</div>
							<div class="form-group">
								<label class="info-title" for="exampleInputEmail2"> Mot
									de passe<span class="requis">*</span>
								</label> <input size="20" maxlength="20" name="motdepasse"
									type="password"
									class="form-control unicase-form-control text-input"
									id="exampleInputEmail2" required> <span class="erreur">${formInscri.erreurs['motdepasse']}</span>

							</div>
							<div class="form-group">
								<label class="info-title" for="exampleInputEmail2">
									Confirmation du mot de passe <span class="requis">*</span>
								</label> <input size="20" maxlength="20" type="password"
									name="confirmation"
									class="form-control unicase-form-control text-input"
									id="exampleInputEmail2" required> <span class="erreur">${formInscri.erreurs['confirmation']}</span>

							</div>

							<button type="submit" value="inscription"
								name="bouton_validation"
								class="btn-upper btn btn-primary checkout-page-button"
								style="width: 100%;">S'inscrire</button>
							<br />
							<p
								class="${empty formInscri.erreurs ? formInscri.htmlClassSucess : formInscri.htmlClassFail}">${formInscri.resultat}</p>
