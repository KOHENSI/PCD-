	...
	<div class="nav-outer">
		<ul class="nav navbar-nav">
			<li class="active dropdown yamm-fw">
				<a href="home.html" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Acceuil</a>
				<ul class="dropdown-menu">
					<li>
...
<!-- ============================================== WIDE PRODUCTS : END ============================================== -->
			...
			<li class="dropdown yamm">
				<a href="home.html" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Ordinateurs</a>
				<ul class="dropdown-menu">
					<li>
						<div class="yamm-content">
    <div class="row">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">  
                    <li><a href="category.html">PC Portables</a></li>
            ...
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">
                    <li><a href="category.html">PC de Bureau</a></li>   
                </ul>
            </div><!-- /.col -->
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">
                    <li><a href="category.html">ALL IN ONE</a></li>  
                </ul>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </li><!-- /.yamm-content -->                    
            ...
            <li class="dropdown menu-item">
                 <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-mobile fa-fw"></i>SmartPhone</a>
<!-- ================================== MEGAMENU VERTICAL ================================== -->            </li><!-- /.menu-item -->

            <li class="dropdown menu-item">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-apple fa-fw"></i>Tablettes PC</a>
            </li><!-- /.menu-item -->

            <li class="dropdown menu-item">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-camera fa-fw"></i>ECRANS PC</a>
               </li><!-- /.menu-item -->

            <li class="dropdown menu-item">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-headphones fa-fw"></i>Image & Son</a>
                <ul class="dropdown-menu mega-menu">
    <li class="yamm-content">
        <div class="row">
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">  
                    <li><a href="category.html">Televiseurs</a></li>
            ...
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">
                   <li><a href="category.html">Appareils Photo</a></li>  
                </ul>
            </div><!-- /.col -->
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">
                    <li><a href="category.html">Videoprojecteurs</a></li>   
                </ul>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </li><!-- /.yamm-content -->                    
            ...
            <li class="dropdown menu-item">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-gamepad fa-fw"></i>IMPRESSION</a>
                <ul class="dropdown-menu mega-menu">
    <li class="yamm-content">
        <div class="row">
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">  
                    <li><a href="category.html">PRODUITS CONSOMMABLES</a></li>
                    <li><a href="category.html">MULTIFONCTION JET D'ENCRE</a></li>       
                </ul>
            </div><!-- /.col -->
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">
                    <li><a href="category.html">MULTIFONCTION LASER MONOCHROME</a></li>
                    <li><a href="category.html">MULTIFONCTION LASER COULEUR</a></li> 
                </ul>
            </div><!-- /.col -->
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">
                    <li><a href="category.html">LASER COULEUR</a></li>
                    <li><a href="category.html">LASER MONOCHROME</a></li>     
                </ul>
            </div><!-- /.col -->
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">
                    <li><a href="category.html">PHOTOCOPIEUR</a></li>
                    <li><a href="category.html">FAX</a></li>    
                </ul>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </li><!-- /.yamm-content -->                    
            ...
            <li class="dropdown menu-item">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-microphone fa-fw"></i>Accessoires</a>
               <ul class="dropdown-menu mega-menu">
    <li class="yamm-content">
        <div class="row">
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">  
                    <li><a href="category.html">Haut-Parleurs</a></li>
                    <li><a href="category.html">Casque micro</a></li>    
                    <li><a href="category.html">Chargeurs</a></li>                                        
                    <li><a href="category.html">Onduleurs</a></li>
                    <li><a href="category.html">Controller et manette de jeux</a></li>
                     <li><a href="category.html">Refroidisseurs</a></li>
                     <li><a href="category.html">Barette memoire</a></li>
                     <li><a href="category.html">Lunette VR</a></li>
            ...
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">
                    <li><a href="category.html">Clavier</a></li>
                    <li><a href="category.html">Disque dur externe</a></li>    
                    <li><a href="category.html">Webcam</a></li>                                        
                    <li><a href="category.html">Souris</a></li>
                    <li><a href="category.html">Flash Disque & Carte SD</a></li>
                    <li><a href="category.html">Ecouteur</a></li>
                    <li><a href="category.html">Disque Dur interne</a></li>
                    <li><a href="category.html">Enregistreur vidéo</a></li>
            ...
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">
                    <li><a href="category.html">Station d'accueil</a></li>
                    <li><a href="category.html">Coque et etui</a></li>    
                    <li><a href="category.html">Hub</a></li>                                        
                    <li><a href="category.html">Adaptateur</a></li> 
                    <li><a href="category.html">Sacoches</a></li> 
                    <li><a href="category.html">Accessoires Tablettes</a></li> 
                    <li><a href="category.html">Tablette Graphique</a></li> 
                    <li><a href="category.html">GRAVEUR</a></li> 
            ...
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">
                    <li><a href="category.html">Cables</a></li>
                    <li><a href="category.html">Routeurs et Points d acces</a></li>    
                    <li><a href="category.html">Switcher</a></li>                                        
                    <li><a href="category.html">Protection et Entretien</a></li>
                    <li><a href="category.html">Dongle TV</a></li>
                    <li><a href="category.html">Power Bank</a></li>
                    <li><a href="category.html">Tapis</a></li>
                    <li><a href="category.html">Fauteuil</a></li>
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Faire des économies</h4>
						</div>
					</div>	
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">Ne plus perdre votre temps</h4>
						</div>
					</div>
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading red">Profitez des réductions</h4>
						</div>
					</div>
...
<c:forEach var="product" items="${ products }" begin="0" end="10" step="1">    	
