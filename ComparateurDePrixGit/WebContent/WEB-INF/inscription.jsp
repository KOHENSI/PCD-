...
<html lang="en">
	<head>
	    ...
	    <!-- Bootstrap Core CSS -->
	   <!--important--><link rel="stylesheet" href="assets/css/bootstrap.min.css">
	    
	    <!-- Customizable CSS -->
	  <!-- form and login--><link rel="stylesheet" href="assets/css/main.css"> 
	   <!--n'est pas important--><link rel="stylesheet" href="assets/css/green.css">
	   <!--bloque Brands-->
	   <link rel="stylesheet" href="assets/css/owl.carousel.css">

		<!--n'est pas important--><link rel="stylesheet" href="assets/css/owl.transitions.css">
		<!--n'est pas important--><link rel="stylesheet" href="assets/css/owl.theme.css">
		<!-- n'est pas important--><link href="assets/css/lightbox.css" rel="stylesheet">
		<!-- n'est pas important--><link rel="stylesheet" href="assets/css/animate.min.css">
		<!-- n'est pas important--><link rel="stylesheet" href="assets/css/rateit.css">
		<!-- n'est pas important--><link rel="stylesheet" href="assets/css/bootstrap-select.min.css">

		<!-- Demo Purpose Only. Should be removed in production -->
		<!-- configuration Should be removed  --><!--<link rel="stylesheet" href="assets/css/config.css"> -->
		...
		<!-- Icons/Glyphs facebook tweeter-->
		<link rel="stylesheet" href="assets/css/font-awesome.min.css">

        <!-- Fonts --> 
		<!-- n'est pas important--><link href='http://fonts.googleapis.com/css?family=Roboto:300,400,500,700' rel='stylesheet' type='text/css'>
		
		<!-- Favicon -->
		<!-- n'est pas important--><link rel="shortcut icon" href="assets/images/favicon.ico">
...
<div class="body-content outer-top-bd">
	<div class="container">
		<div class="sign-in-page inner-bottom-sm">
			<div class="row">
				<!-- Sign-in -->			
<div class="col-md-6 col-sm-6 sign-in" style="height: 100% ;">
	<h4 class="">SE CONNECTER</h4>
	<p class="">Bonjour, Bienvenue sur votre compte.</p>
	<p style="color: #0084B9 ;">Connectez-vous avec :</p>
	<div class="social-sign-in outer-top-xs" style="text-align: center ; ">
		<a href="#" class="facebook-sign-in" style="width: 48% ;"><i class="fa fa-facebook" ></i>Facebook</a>
		<a href="#" class="twitter-sign-in" style="width: 48% ;"><i class="fa fa-twitter"></i>Twitter</a>
	</div>
	...
	<form class="register-form outer-top-xs" role="form"  >
		...
		<div class="radio outer-xs">
		  	<label>
		    	<input type="radio" name="optionsRadios" id="optionsRadios2" value="option2">Souviens-toi de moi!
		  	</label>
		  	<a href="#" class="forgot-password pull-right">Mot de passe oublié?</a>
		</div>
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" style="width: 100%; ">S'identifier</button>
	</form>	
...
<div class="col-md-6 col-sm-6 create-new-account"  style="height: 100% ;">
	<h4 class="checkout-subtitle">CRÉER UN NOUVEAU COMPTE
</h4>

	<p class="text title-tag-line" >Créez votre propre compte Unicase.</p>

	<form method="post" class="register-form outer-top-xs" action="inscription">
		<div class="form-group">
	    	<label class="info-title" for="exampleInputEmail2">Adresse email <span class="requis">*</span></label>
	    	<input value="<c:out value="${member.email}"/>" size="20" maxlength="60"  type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail2" name="email">
	    	<span class="erreur">${form.erreurs['email']}</span> 
	  	</div>
	  		<div class="form-group">
	    	<label class="info-title" for="exampleInputEmail2">Pseudonyme <span class="requis">*</span></label>
	    	<input type="text" name="nom" class="form-control unicase-form-control text-input" id="exampleInputEmail2" value="<c:out value="${member.pseudonym}"/>"
				size="20" maxlength="20"  >
				<span class="erreur">${form.erreurs['nom']}</span>
	  	</div>
	  	<div class="form-group">
	    	<label class="info-title" for="exampleInputEmail2"> Mot de passe<span class="requis">*</span></label>
	    	<input size="20" maxlength="20"  name="motdepasse" type="password" class="form-control unicase-form-control text-input" id="exampleInputEmail2" >
	    	<span class="erreur">${form.erreurs['motdepasse']}</span>
			
	  	</div>
	  	<div class="form-group">
	    	<label class="info-title" for="exampleInputEmail2"> Confirmation du mot de passe <span class="requis">*</span></label>
	    	<input size="20" maxlength="20"  type="password" name="confirmation" class="form-control unicase-form-control text-input" id="exampleInputEmail2" >
	    	<span class="erreur">${form.erreurs['confirmation']}</span>
			
	  	</div>
	  	
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" style="width: 100%; ">S'inscrire</button>
	</form>
	...
	<form method="post" action="inscription">
		<fieldset>
			...
			<input type="email" id="email" name="email"
				value="<c:out value="${member.email}"/>" size="20" maxlength="60" />
			...
			<br /> <label for="confirmation">Confirmation du mot de
				...
				value="" size="20" maxlength="20" /> <span class="erreur">${form.erreurs['confirmation']}</span>
			<br /> <label for="nom">Nom d'utilisateur</label> <input type="text"
				id="nom" name="nom" value="<c:out value="${member.pseudonym}"/>"
				size="20" maxlength="20" /> <span class="erreur">${form.erreurs['nom']}</span>
