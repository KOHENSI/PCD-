...
insert into categories (pid , name) values (0,"Impression");
	...
	insert into categories (pid , name) select id , "Scanner" from categories where name = "Impression";
...
insert into categories (pid , name) values (0,"Accessoires");
	...
	insert into categories (pid , name) select id , "Micro casque et Kit" from categories where name = "Accessoires";
	insert into categories (pid , name) select id , "Carte Memoire" from categories where name = "Accessoires";	
	insert into categories (pid , name) select id , "Clé USB" from categories where name = "Accessoires";	
	insert into categories (pid , name) select id , "SSD" from categories where name = "Accessoires";
...
insert into categories (id,pid , name) values (99,0,"NonInformatique");